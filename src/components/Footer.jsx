...
const tweetList = [
  {
    ...
    desc: (
      <p>
      <a href="#">@ShopCart Greetings! #HTML_Template</a> Grab
  ...
  },
  {
    ...
    desc: (
      <p>
        <a href="#">@ShopCart Hey! #HTML_Template</a> Grab your
      ...
      <div className="footer-bottom">
        <div className="container">
            <div className="section-wrapper">
                <p>&copy; 2024 <Link to="/">Shop Cart</Link> Designed by <a href="/" target="_blank">QKH</a></p>
